...
public class TripPoint {
    ...
    public static void main(String[] args) {
       // Set up frame
        JFrame frame = new JFrame("Trip Analyzer by Markus ");
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Implement animation based on selected options
            }
        });
        ...
        JComboBox<String> animationTimeComboBox = new JComboBox<>();
        animationTimeComboBox.addItem("1x");
        animationTimeComboBox.addItem("2x");
        animationTimeComboBox.addItem("3x");
        ...
        frame.add(map);
        // Assuming you have a MapViewer class, create and add it here

        // Read file and call stop detection
        try {
            readFile("triplog.csv");
            if (stopCheckBox.isSelected()) {
                int numStops = h1StopDetection();
                System.out.println("Number of stops detected (Heuristic 1): " + numStops);
                // or you can use h2StopDetection() for heuristic 2
            }
        ...
        // Assuming you have methods to set map center and zoom level
        // mapViewer.setMapCenter(center);
        // mapViewer.setZoomLevel(zoom);
